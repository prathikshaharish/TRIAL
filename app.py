...
st.markdown("" <h1 style='text-align: center; font-weight: bold;'>EMG - EEG Sensor-Based Exoskeleton for Knee Injury Rehabilitation</h1>
    <h4 style='text-align: center;'>By - Prakruthi Harish , Prathiksha Harish, Krithik Raj K, Prajval Prakash, and Dr. Jisha P</h4> "", unsafe_allow_html=True)
...
if st.button("Predict"):
    classifications, overall_classification = classify_emg_eeg(emg_rest, emg_flexion, emg_extension, eeg_rest, eeg_flexion, eeg_extension)
